...
void algo_cimm(){
	...
	file.open(save_address + "_cimm_eps=2_new", ios::out);
	file_time.open(time_address + "_cimm_eps=2_new", ios::out);
	double delta = 0.1;
	...
	file.open(save_address + "_cimm_eps=1_new", ios::out);
	file_time.open(time_address + "_cimm_eps=1_new", ios::out);
	for(int k = 5; k < 51; k=k+5){
		double running_time = 0.0;
		double num_spread = 0.0;
		for (int iter = 0; iter < 5; iter++)
	...
	file.open(save_address + "_cimm_eps=0.5_new", ios::out);
	file_time.open(time_address + "_cimm_eps=0.5_new", ios::out);
	for (int k = 5; k < 51; k = k + 5) {
		double running_time = 0.0;
		double num_spread = 0.0;
		for (int iter = 0; iter < 5; iter++)
...
void algo_cimm_2(){
	...
	file.open(save_address + "_cimm_2_eps=2_new", ios::out);
	file_time.open(time_address + "_cimm_2_eps=2_new", ios::out);
	for (int k = 5; k < 51; k = k + 5) {
		double running_time = 0.0;
		double num_spread = 0.0;
		for (int iter = 0; iter < 5; iter++)
